...
There are copious useful webpages to reference information relevant to the resident on the molecular rotation. A few of the more commonly used ones are below.
  ...
  5. Expertpath: (<https://www.expertpath.com/>). This site should be familiar to all the residents and provides and excellent overview of almost every disease including key molecular diagnostic and prognostic factors. 
